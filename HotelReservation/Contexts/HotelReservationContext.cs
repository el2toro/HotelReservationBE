    ...
    public class HotelReservationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>().HasData(
                new Booking { BookingId = 1, GuestId = 1, RoomId = 1, CheckInDate = new DateTime(2025, 01, 15), CheckOutDate = new DateTime(2025, 01, 20), TotalAmount = 1500.00m, BookingStatus = "Confirmed", BookingDate = DateTime.Now },
                new Booking { BookingId = 2, GuestId = 2, RoomId = 3, CheckInDate = new DateTime(2025, 02, 10), CheckOutDate = new DateTime(2025, 02, 15), TotalAmount = 500.00m, BookingStatus = "Confirmed", BookingDate = DateTime.Now },
